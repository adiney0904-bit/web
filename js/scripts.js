...
const Chat = {
    ...
    setupEventListeners: () => {
        ...
        const supportChatCard = document.getElementById('supportChatCard');
        ...
        const toggleChat = () => {
            ...
            if (isActive) {
                ...
                // Remover indicador visual de todos los elementos
                if (contactToggle) contactToggle.classList.remove('active');
                if (chatToggle) chatToggle.classList.remove('active');
                if (supportChatCard) supportChatCard.classList.remove('active');
            } else {
                // Mostrar chat
                chatWidget.classList.add('active');
                // Agregar indicador visual a todos los elementos
                if (contactToggle) contactToggle.classList.add('active');
                if (chatToggle) chatToggle.classList.add('active');
                if (supportChatCard) supportChatCard.classList.add('active');
        ...
        // Tarjeta de Soporte 24/7 en la sección de servicios
        if (supportChatCard) {
            supportChatCard.addEventListener('click', toggleChat);
        }
        ...
        document.addEventListener('click', (e) => {
            if (chatWidget && chatWidget.classList.contains('active')) {
                ...
                const isClickOnToggle = (contactToggle && contactToggle.contains(e.target)) || 
                                       (chatToggle && chatToggle.contains(e.target)) ||
                                       (supportChatCard && supportChatCard.contains(e.target));
...
const Gallery = {
    ...
    galleryItems: [
        {
            ...
            description: `
                <div class="detailed-info">
                    ...
                    <p>Ferretería ForgeLine cuenta con <strong>850 m² de área total</strong> en ubicación estratégica de Peña Blanca, Cortés. Instalaciones diseñadas para la comodidad y eficiencia de nuestros clientes.</p>
                    
                    <h4>🚗 Facilidades de Acceso</h4>
                    <ul>
                        <li><strong>Estacionamiento gratuito</strong> - Capacidad para 25 vehículos</li>
                        <li><strong>Acceso universal</strong> - Rampas y puertas amplias</li>
                        <li><strong>Zona de carga</strong> - Para materiales pesados y voluminosos</li>
                        <li><strong>Seguridad 24/7</strong> - Sistema de cámaras y vigilancia</li>
                    </ul>
                    
                    <h4>🕒 Horarios de Atención</h4>
                    <p><strong>Lunes a Sábado:</strong> 7:00 AM - 7:00 PM<br>
                    <strong>Domingos:</strong> 8:00 AM - 4:00 PM<br>
                    <em>Horarios extendidos disponibles con cita previa</em></p>
                    
                    <h4>📍 Ubicación Estratégica</h4>
                    <p>Calle principal, barrio al centro, Peña Blanca. <strong>Fácil acceso</strong> desde rutas principales de Cortés y conexión directa con San Pedro Sula. A solo 15 minutos del centro de la ciudad.</p>
                </div>
            `,
            type: 'image'
        },
        {
            ...
            description: `
                <div class="detailed-info">
                    <h4>🏪 Showroom Organizado</h4>
                    <p><strong>600 m² de exhibición</strong> diseñados para una experiencia de compra eficiente. Pasillos amplios, señalización clara y organización por departamentos especializados.</p>
                    
                    <h4>📦 Departamentos Especializados</h4>
                    <ul>
                        <li><strong>Sector A:</strong> Herramientas Manuales (150+ productos)</li>
                        <li><strong>Sector B:</strong> Herramientas Eléctricas (80+ productos)</li>
                        <li><strong>Sector C:</strong> Plomería y Electricidad (200+ productos)</li>
                        <li><strong>Sector D:</strong> Construcción y Pintura (180+ productos)</li>
                        <li><strong>Sector E:</strong> Jardinería y Seguridad (100+ productos)</li>
                    </ul>
                    
                    <h4>💡 Comodidades</h4>
                    <ul>
                        <li><strong>Iluminación LED</strong> - Visualización óptima de productos</li>
                        <li><strong>Aire acondicionado</strong> - Ambiente confortable</li>
                        <li><strong>Área de pruebas</strong> - Testeo de herramientas eléctricas</li>
                        <li><strong>Inventario digital</strong> - Consulta en tiempo real</li>
                        <li><strong>Asesoría especializada</strong> - Personal en cada sector</li>
                    </ul>
                </div>
            `,
            type: 'image'
        ...
        {
            src: 'assets/images/trabajadores.png',
            title: 'Nuestro Equipo',
            description: `
                <div class="detailed-info">
                    <h4>👥 Equipo Profesional</h4>
                    <p><strong>12 especialistas capacitados</strong> con experiencia específica en construcción, plomería, electricidad y herramientas. Cada miembro está certificado y actualizado en las últimas tecnologías.</p>
                    
                    <h4>🎓 Especialistas Principales</h4>
                    <ul>
                        <li><strong>Ing. Carlos Mendoza</strong> - Gerente General (15 años)</li>
                        <li><strong>Téc. María González</strong> - Plomería (10 años)</li>
                        <li><strong>Téc. Roberto Silva</strong> - Electricidad (12 años)</li>
                        <li><strong>Téc. Ana Rodríguez</strong> - Herramientas (8 años)</li>
                        <li><strong>Arq. Luis Pérez</strong> - Construcción (6 años)</li>
                    </ul>
                    
                    <h4>🏆 Certificaciones</h4>
                    <ul>
                        <li><strong>Seguridad Industrial</strong> - Todo el personal</li>
                        <li><strong>Atención al Cliente</strong> - Capacitación continua</li>
                        <li><strong>Productos y Tecnología</strong> - Actualización mensual</li>
                        <li><strong>Primeros Auxilios</strong> - Personal certificado</li>
                    </ul>
                    
                    <h4>🤝 Asesoría Técnica Gratuita</h4>
                    <p>Estimación de materiales, recomendaciones especializadas, seguimiento post-venta. Disponible <strong>presencial, telefónica y WhatsApp</strong>.</p>
                    
                    <h4>📞 Contacto: +504 9583-4797</h4>
                </div>
            `,
            type: 'image'
        },
        {
            src: 'assets/images/herramientas.mp4',
            title: 'Herramientas Premium',
            description: `
                <div class="detailed-info">
                    <h4>🔧 Marcas de Calidad Internacional</h4>
                    <p>Trabajamos con <strong>marcas reconocidas mundialmente</strong> que garantizan durabilidad, precisión y seguridad en cada herramienta.</p>
                    
                    <h4>🏭 Marcas Principales</h4>
                    <ul>
                        <li><strong>DEWALT</strong> - Herramientas eléctricas profesionales</li>
                        <li><strong>STANLEY</strong> - Herramientas manuales clásicas</li>
                        <li><strong>MILWAUKEE</strong> - Tecnología avanzada</li>
                        <li><strong>MAKITA</strong> - Calidad japonesa</li>
                        <li><strong>BOSCH</strong> - Innovación alemana</li>
                        <li><strong>BLACK & DECKER</strong> - Herramientas para hogar</li>
                    </ul>
                    
                    <h4>⚡ Categorías</h4>
                    <ul>
                        <li><strong>Eléctricas</strong> - Taladros, sierras, lijadoras (20V-220V)</li>
                        <li><strong>Manuales</strong> - Llaves, destornilladores, martillos</li>
                        <li><strong>Neumáticas</strong> - Compresores y accesorios</li>
                        <li><strong>Medición</strong> - Niveles, metros, multímetros</li>
                        <li><strong>Jardinería</strong> - Podadoras, mangueras, aspersores</li>
                    </ul>
                    
                    <h4>✅ Servicios</h4>
                    <ul>
                        <li><strong>Garantía del fabricante</strong> - Todas las herramientas</li>
                        <li><strong>Servicio técnico autorizado</strong> - Reparaciones</li>
                        <li><strong>Demostración gratuita</strong> - Antes de comprar</li>
                        <li><strong>Financiamiento</strong> - Planes de 3, 6 y 12 meses</li>
                    </ul>
                </div>
            `,
            type: 'video'
        ...
        {
            src: 'assets/images/Set de Herramientas Plomería.jpg',
            title: 'Departamento de Plomería',
            description: `
                <div class="detailed-info">
                    <h4>🚰 Soluciones Completas de Plomería</h4>
                    <p>Departamento especializado con <strong>más de 300 productos</strong> para plomería residencial, comercial e industrial. Todo lo necesario desde reparaciones hasta instalaciones completas.</p>
                    
                    <h4>🔧 Herramientas Especializadas</h4>
                    <ul>
                        <li><strong>Llaves para tuberías</strong> - Medidas 1/2" a 4"</li>
                        <li><strong>Cortadores de tubo</strong> - PVC, cobre y acero</li>
                        <li><strong>Soldadores y sopletes</strong> - Uniones de cobre</li>
                        <li><strong>Destapacaños</strong> - Manuales y eléctricos</li>
                        <li><strong>Detectores de fugas</strong> - Equipos profesionales</li>
                    </ul>
                    
                    <h4>🚿 Materiales y Accesorios</h4>
                    <ul>
                        <li><strong>Tubería PVC</strong> - 1/2" hasta 6" de diámetro</li>
                        <li><strong>Tubería de cobre</strong> - Tipo L y M</li>
                        <li><strong>Conexiones completas</strong> - Codos, tees, reductores</li>
                        <li><strong>Grifería</strong> - Cocina, baño, lavandería</li>
                        <li><strong>Calentadores</strong> - Eléctricos y gas, 20-80 galones</li>
                    </ul>
                    
                    <h4>🏠 Servicios Especializados</h4>
                    <ul>
                        <li><strong>Diseño de sistemas</strong> - Planos hidráulicos</li>
                        <li><strong>Estimación de materiales</strong> - Cotizaciones detalladas</li>
                        <li><strong>Asesoría técnica</strong> - Instalación paso a paso</li>
                        <li><strong>Directorio de plomeros</strong> - Profesionales recomendados</li>
                    </ul>
                    
                    <h4>📋 Cumplimiento Normativo</h4>
                    <p>Productos certificados según <strong>normas hondureñas de construcción</strong>. Asesoría gratuita sobre códigos vigentes.</p>
                </div>
            `,
            type: 'image'
        },
        {
            src: 'assets/images/Cemento.png',
            title: 'Materiales de Construcción',
            description: `
                <div class="detailed-info">
                    <h4>🏗️ Materiales de Primera Calidad</h4>
                    <p>Inventario completo de <strong>materiales certificados</strong> para obras residenciales, comerciales e industriales. Proveedores nacionales e internacionales de confianza.</p>
                    
                    <h4>🧱 Cemento y Concreto</h4>
                    <ul>
                        <li><strong>Cemento Portland</strong> - Bolsas 42.5kg (Tipo I y II)</li>
                        <li><strong>Cemento Blanco</strong> - Acabados especiales</li>
                        <li><strong>Cal Hidratada</strong> - Morteros y repellos</li>
                        <li><strong>Aditivos</strong> - Plastificantes, acelerantes</li>
                        <li><strong>Concreto premezclado</strong> - Entrega con mixer</li>
                    </ul>
                    
                    <h4>🗿 Agregados</h4>
                    <ul>
                        <li><strong>Arena de río</strong> - Lavada y clasificada</li>
                        <li><strong>Grava</strong> - Gradaciones 3/8", 1/2", 3/4"</li>
                        <li><strong>Piedrín</strong> - Concreto estructural</li>
                        <li><strong>Arena pómez</strong> - Bloques livianos</li>
                        <li><strong>Balasto</strong> - Rellenos y nivelación</li>
                    </ul>
                    
                    <h4>🧱 Bloques y Ladrillos</h4>
                    <ul>
                        <li><strong>Bloques de concreto</strong> - 6", 8", 10", 12", 15"</li>
                        <li><strong>Ladrillos de barro</strong> - Rojos y refractarios</li>
                        <li><strong>Adoquines</strong> - Pavimentos y jardines</li>
                        <li><strong>Tejas</strong> - Barro, concreto, fibrocemento</li>
                    </ul>
                    
                    <h4>🚛 Entrega a Domicilio</h4>
                    <ul>
                        <li><strong>Gratuita</strong> - Compras +L.5,000 (15km)</li>
                        <li><strong>Flota propia</strong> - 5 camiones disponibles</li>
                        <li><strong>Horario flexible</strong> - 7:00 AM - 6:00 PM</li>
                        <li><strong>Programación</strong> - Hasta 3 días anticipación</li>
                    </ul>
                    
                    <h4>📊 Calculadora de Materiales Gratuita</h4>
                    <p>Ingenieros especializados calculan cantidades exactas para optimizar presupuesto y evitar desperdicios.</p>
                    
                    <h4>🏆 Certificación ASTM</h4>
                    <p>Materiales con <strong>certificaciones internacionales</strong> respaldados por laboratorios.</p>
                </div>
            `,
            type: 'image'
        }
    ...
    initHoverEffects: () => {
        // Inicializar videos con autoplay en hover
    ...
    openModal: (index) => {
        ...
        const modal = document.getElementById('galleryModal');
        const item = Gallery.galleryItems[index];
        
        Gallery.updateModalContent(item);
        Gallery.updateNavigation();
        Gallery.updateCounter();
        
        modal.classList.add('active');
        document.body.style.overflow = 'hidden';
        
        Utils.showNotification(`Viendo: ${item.title}`, 'info');
    },
    ...
    updateNavigation: () => {
        ...
        if (prevBtn) {
            prevBtn.disabled = Gallery.currentIndex === 0;
        }
        
        if (nextBtn) {
            nextBtn.disabled = Gallery.currentIndex === Gallery.galleryItems.length - 1;
        }
    },
    ...
    updateCounter: () => {
        ...
        if (counter) {
            counter.textContent = `${Gallery.currentIndex + 1} de ${Gallery.galleryItems.length}`;
        }
    },
    ...
    previousImage: () => {
        if (Gallery.currentIndex > 0) {
            ...
            const item = Gallery.galleryItems[Gallery.currentIndex];
            Gallery.updateModalContent(item);
            Gallery.updateNavigation();
            Gallery.updateCounter();
        }
    ...
    nextImage: () => {
        if (Gallery.currentIndex < Gallery.galleryItems.length - 1) {
            Gallery.currentIndex++;
            const item = Gallery.galleryItems[Gallery.currentIndex];
            Gallery.updateModalContent(item);
            Gallery.updateNavigation();
    ...
    // Función para mostrar una imagen específica (puede ser llamada externamente)
    showImage: (index) => {
        if (index >= 0 && index < Gallery.galleryItems.length) {
            Gallery.openModal(index);
        }
    }
};
